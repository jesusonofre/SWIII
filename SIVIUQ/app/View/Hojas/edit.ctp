...
<?php echo $this->Form->create('Hoja'); ?>
	<fieldset>
		<legend><?php echo __('Edit Hoja'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Hoja.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Hoja.id'))); ?></li>
