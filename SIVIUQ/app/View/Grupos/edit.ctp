...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Grupo.id')), array(), __('Estas seguro de eliminar a # %s?', $this->Form->value('Grupo.id'))); ?></li>
