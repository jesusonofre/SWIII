...
<?php echo $this->Form->create('Revision'); ?>
	<fieldset>
		<legend><?php echo __('Editar Revision'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Revision.id')), array(), __('Estas seguro de eliminar a # %s?', $this->Form->value('Revision.id'))); ?></li>
